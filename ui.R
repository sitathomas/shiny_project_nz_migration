	    ...
	    tabItems(
	      ...
	      tabItem(tabName = "region",
	      	p("Here you can explore some of the data available for Permanent and
	      		Long-Term Migration to New Zealand from 2010-2017. This data can be
	      		used by individuals considering migration, businesses wanting to
	      		target certain demographics for marketing purposes, or organizations
	      		wanting to offer useful resources and/or services to migrants."),
	      ...
	      tabItem(tabName = "visa",
	        ...
	        plotOutput("arrivals_by_visa"),
	      	...
	      	p("Given that work and student visas combined make up the majority of
	      		...
	      		young adults. Citizens returning to New Zealand do so most often
	      		between ages 25 and 29, potentially indicating that education
	      		and/or early career opportunities were pursued overseas."),
	      	selectizeInput(
	      		inputId = "visa_type",
	      ...
	      tabItem(tabName = "age",
	        p("Most arrivals are in their teens, 20s, and early 30s, but their
	        	...
	        	their residency, such as length of stay or economic
	        	contributions."),
